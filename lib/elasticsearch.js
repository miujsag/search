...
function search (client, query, sites = [], categories = [], from = addMonths(new Date(), - 1), until = new Date(), skip = 0) {
  console.log({client, query, sites, categories, from, until, skip})
